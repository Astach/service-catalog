...
output "QOVERY_REDIS_VPC_ID" {
  description = "The VPC ID where ElastiCache is deployed"
  value       = local.vpc_id
}

output "QOVERY_REDIS_SECURITY_GROUP_ID" {
